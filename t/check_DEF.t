...
FAIL_ON_INIT { my $uninitialized : of(DEF) } 'uninitialized my scalar';
FAIL_ON_INIT { state $uninitialized : of(DEF) } 'uninitialized state scalar';

# Other explicit initializer values also don't pass the DEF check...
for my $bad_value (BAD_VALUES) {
    my $bad_value_str = Data::Checks::Parser::pp($bad_value);
    FAIL_ON_INIT { my $uninitialized : of(DEF)    = $bad_value } "   my scalar = $bad_value_str";
    FAIL_ON_INIT { our $uninitialized : of(DEF)   = $bad_value } "  our scalar = $bad_value_str";
    FAIL_ON_INIT { state $uninitialized : of(DEF) = $bad_value } "state scalar = $bad_value_str";
}
