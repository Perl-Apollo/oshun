...
use Data::Checks::TestUtils 'INT[-100, -9..9, 100, m/7$|42/, UINT[99]|UINT[88], 999..inf]';
...
my    sub    my_sub :returns(INT[-100, -9..9, 100, m/7$|42/, UINT[99]|UINT[88], 999..inf])  ($param :of(INT[-100, -9..9, 100, m/7$|42/, UINT[99]|UINT[88], 999..inf]))  { return $param }
state sub state_sub :returns(INT[-100, -9..9, 100, m/7$|42/, UINT[99]|UINT[88], 999..inf])  ($param :of(INT[-100, -9..9, 100, m/7$|42/, UINT[99]|UINT[88], 999..inf]))  { return $param }
...
# With values that SHOULDN'T pass the INT[-100, -9..9, 100, m/7$|42/, UINT[99]|UINT[88], 999..inf] check...
for my $bad_value (BAD_VALUES) {
    my $bad_value_str = Data::Checks::pp($bad_value);
