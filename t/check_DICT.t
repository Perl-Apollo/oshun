...
my $my_scalar :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) = { num => 1.1, '*u*' => 2, 99 => 'three', etc => {} };
our $our_scalar :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) = { num => 1.1, '*u*' => 2, 99 => 'three', etc => {} };
state $state_scalar :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) = { num => 1.1, '*u*' => 2, 99 => 'three', etc => {} };
...
sub old_sub :
  returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) { my $x :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) = shift; return $x }
sub new_sub :
  returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) ( $param :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) ) { return $param }
my sub my_sub :
  returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) ( $param :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) ) { return $param }
state sub state_sub :
  returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) ( $param :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH]) ) { return $param }
