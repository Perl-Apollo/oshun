...
my    $my_scalar    :of(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]])
    = {num=>1.1, '*u*'=>2, 99=>'three', etc=>{}};
our   $our_scalar   :of(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]])
    = {num=>1.1, '*u*'=>2, 99=>'three', etc=>{}};
state $state_scalar :of(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]])
    = {num=>1.1, '*u*'=>2, 99=>'three', etc=>{}};
...
# Test subroutines: parameters, internal variables, return values...
      ...
      sub   old_sub :returns(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]])                     { my $x :of(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]]) = shift; return $x }
      sub   new_sub :returns(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]])  ($param :of(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]]))  { return $param }
my    sub    my_sub :returns(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]])  ($param :of(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]]))  { return $param }
state sub state_sub :returns(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]])  ($param :of(DICT['num' => NUM, OPT[qq{*u*} => UINT], 99 => STR, OPT['etc' => HASH]]))  { return $param }
