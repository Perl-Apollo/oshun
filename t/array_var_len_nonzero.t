...
for my $good_value (GOOD_VALUES) {
    my $good_value_str = Data::Checks::Parser::pp($good_value);
    FAIL_ON_LENGTH { @my_array  = ($good_value) x  1 } " my array = $good_value_str x  1";
    FAIL_ON_LENGTH { @our_array = ($good_value) x  1 } "our array = $good_value_str x  1";
...
for my $good_value (GOOD_VALUES) {
    ...
    OKAY { () =     old_sub( ($good_value) x 2 ) }   "  old_sub( $good_value_str )";
    OKAY { () =     new_sub( ($good_value) x 2 ) }   "  new_sub( $good_value_str )";
    OKAY { () =      my_sub( ($good_value) x 2 ) }   "   my_sub( $good_value_str )";
    OKAY { () =   state_sub( ($good_value) x 2 ) }   "state_sub( $good_value_str )";
    ...
    FAIL_ON_LENGTH_OLD  { () =     old_sub( ($good_value) x  1 ) }   "  old_sub( $good_value_str )";
    FAIL_ON_LENGTH_INIT { () =     new_sub( ($good_value) x  1 ) }   "  new_sub( $good_value_str )";
    FAIL_ON_LENGTH_INIT { () =      my_sub( ($good_value) x  1 ) }   "   my_sub( $good_value_str )";
    FAIL_ON_LENGTH_INIT { () =   state_sub( ($good_value) x  1 ) }   "state_sub( $good_value_str )";
...
for my $bad_value (BAD_VALUES) {
    ...
    FAIL_ON_UNPACK { scalar   old_sub( $bad_value, $bad_value ) }       "  old_sub( $bad_value_str )";
    FAIL_ON_PARAM  { scalar   new_sub( $bad_value, $bad_value ) }       "  new_sub( $bad_value_str )";
    FAIL_ON_PARAM  { scalar    my_sub( $bad_value, $bad_value ) }       "   my_sub( $bad_value_str )";
    FAIL_ON_PARAM  { scalar state_sub( $bad_value, $bad_value ) }       "state_sub( $bad_value_str )";
}
