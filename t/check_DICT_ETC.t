...
my    $my_scalar    :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC])
    = {num=>1.1, '*u*'=>2, 99=>'three', etc=>{}};
our   $our_scalar   :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC])
    = {num=>1.1, '*u*'=>2, 99=>'three', etc=>{}};
state $state_scalar :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC])
    = {num=>1.1, '*u*'=>2, 99=>'three', etc=>{}};
...
# Test subroutines: parameters, internal variables, return values...
      ...
      sub   old_sub :returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC])                     { my $x :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC]) = shift; return $x }
      sub   new_sub :returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC])  ($param :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC]))  { return $param }
my    sub    my_sub :returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC])  ($param :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC]))  { return $param }
state sub state_sub :returns(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC])  ($param :of(DICT['num' => NUM, qq{*u*} => UINT, 99 => STR, 'etc' => HASH, ETC]))  { return $param }
